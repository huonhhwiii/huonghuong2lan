...
# MySQL Configuration
app.config['MYSQL_HOST'] = 'mysql-container'  # Tên container MySQL
app.config['MYSQL_USER'] = 'root'             # Tên người dùng MySQL
app.config['MYSQL_PASSWORD'] = 'huong24052005'     # Mật khẩu MySQL
app.config['MYSQL_DB'] = 'ql_benh_nhan'       # Tên database
app.config['MYSQL_PORT'] = 3306               # Port mặc định của MySQL
